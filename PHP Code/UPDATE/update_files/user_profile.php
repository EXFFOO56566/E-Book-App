		...
		<div class="card-body no-padding tab-content">
			...
			<div role="tabpanel" class="tab-pane" id="continue_book">
				<div class="row">
					...
					$users_qry1="SELECT tbl_books.`book_title`, tbl_books.`book_cover_img`,tbl_books.`cat_id`,tbl_books.`rate_avg`,tbl_books.`book_views`,tbl_books.`aid`,tbl_user_continue.`con_id` as continue_id FROM tbl_user_continue
					...
					ORDER BY continue_id DESC LIMIT $start, $limit";
						...
						<div class="col-lg-3 col-sm-4 col-xs-12">
							<div class="block_wallpaper" style="box-shadow:2px 3px 5px #333;">
								...
								<ul>
									...
									<li><a href="" data-id="<?php echo $row_all1['continue_id'];?>" data-toggle="tooltip" data-tooltip="Delete" class="btn_delete_a"><i class="fa fa-trash"></i></a></li>	
								</ul>
							</div>
