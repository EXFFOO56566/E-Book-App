...
if(isset($_POST['submit']))
{
	...
	$message=filter_var($_POST['notification_msg'], FILTER_SANITIZE_STRING);
...
{
	$data = array(
		'onesignal_app_id' => filter_var($_POST['onesignal_app_id'], FILTER_SANITIZE_STRING),
		'onesignal_rest_key' => filter_var($_POST['onesignal_rest_key'], FILTER_SANITIZE_STRING),
	);
			...
			<div class="card-body mrg_bottom" style="padding: 0px"> 
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active">
						<a href="#notification_settings" name="Notification Settings" aria-controls="notification_settings" role="tab" data-toggle="tab"><i class="fa fa-wrench"></i> Notification Settings</a>
					</li>
					<li role="presentation">
						<a href="#send_notification" aria-controls="send_notification" name="Send notification" role="tab" data-toggle="tab"><i class="fa fa-send"></i> Send Notification</a>
					</li>
