  ...
  <div class="col-lg-4">
    <div class="container-fluid" style="background: #FFF;box-shadow: 0px 5px 10px 0px #CCC;border-radius: 2px">
      ...
      <table class="table table-hover">
        ...
        $sql_book="SELECT tbl_user_continue.`con_id`, count(book_id) AS num, tbl_books.* FROM tbl_user_continue
        ...
        $res=mysqli_query($mysqli, $sql_book) or die(mysqli_error($mysqli));
  ...
  <div class="col-lg-4">
    <div class="container-fluid" style="background: #FFF;box-shadow: 0px 5px 10px 0px #CCC;border-radius: 2px">
      ...
      <table class="table table-hover">
        ...
        $sql_fav="SELECT tbl_books.*, count(book_id) AS num, tbl_favourite.`fa_id` FROM tbl_favourite
        ...
        $res=mysqli_query($mysqli, $sql_fav) or die(mysqli_error($mysqli));
