...
function Send_FCM_msg($registration_id,$data)
{

    $data1 = array("Notice" => $data);
...
function save_activity_log($user_id)
{   
    global $mysqli;
...
function checkSignSalt($data_info){
    ...
    $data_arr = json_decode_nice(base64_decode($data_json),true);
